...
mydata.to_excel("P2E_games.xlsx")
#mydata.to_csv('P2E.csv')


#Open the desired workbook using openpyxl
wb = openpyxl.load_workbook(r'C:\Users\malgo\Desktop\M2E\webscraping\webscraping\P2E_games.xlsx')
...
wb.save(r'C:\Users\malgo\Desktop\M2E\webscraping\webscraping\P2E_games.xlsx')